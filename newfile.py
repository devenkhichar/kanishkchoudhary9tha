...
for i in range(1,6):
    ...
    mushrooms.append(pygame.Rect(i*60,100,40,40))
    carrots.append(pygame.Rect(i*60,150,40,40))
    brinjals.append(pygame.Rect(i*60,200,40,40))
    pumpkins.append(pygame.Rect(i*60,250,40,40))
